...
const {createUser, login, getUsers, getOneUser, deleteUser,forgotPasswordToken,resetPassword,
    updateUser, blockUser, unblockUser, handleRefreshToken, logout, updatePassword} = require('../controller/userCtrl');
